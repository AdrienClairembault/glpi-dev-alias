...
# Install database
alias ginstall="php bin/console glpi:database:install --no-telemetry -pteclib -uteclib"
...
# E2e tests
alias open-e2e="export CYPRESS_BASE_URL="http://localhost:8083" && npm run test:e2e"
alias run-e2e-local="export CYPRESS_BASE_URL="http://localhost:8083" && npx cypress run --project tests"
alias run-e2e-docker="export CYPRESS_BASE_URL="http://localhost:8083" && ./tests/run_tests.sh e2e"
